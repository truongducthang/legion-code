export const SUB_TASK_PREAMBLE = `[SUB-TASK MODE] You are a coordinated sub-task inside Legion. A coordinator agent dispatched you to complete specific work.
