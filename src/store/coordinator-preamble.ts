 ...
 */
export const COORDINATOR_PREAMBLE = `[COORDINATOR MODE] You are a coordinating agent inside Legion. \
...
RULES:
1. You MUST NOT use your built-in Agent tool to spawn new Legion tasks — you MUST use \
